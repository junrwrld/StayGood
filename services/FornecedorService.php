<?php
    ...
    include 'Fornecedor.php'; //incluir o arquivo Fornecedor.php
    class FornecedorService 
    {
          ...
          public function get( $id = null )
          {
              if ($id){// se existe $id  
                 ...
                 return Fornecedor::select($id) ;
              }else{
                 //retornar resultado do método selectAll() da class Fornecedor
                 return Fornecedor::selectAll() ;
              }
          ...
          public function post()
          {
            //Pegar os dados em formato JSON para incluir no BD.
              ...
              return Fornecedor::insert($dados);     
          }
          ...
          public function put($id = null)
          {
            if ($id == null){
              ...
              return Fornecedor::update($id,$dados); 
          }
    }