     ...
     /* criarmos uma classe para ter acesso ao BD e criarmos dois métodos  de consulta:
      ...
      class Estoque 
      {
        ...
        public static function select(int $id)
        {
            ...
            $tabela = "estoque"; //variável para nome da tabela
            $coluna = "idEstoque"; //variável para chave primaria
        ...
        {
            $tabela = "estoque"; //uma variável para nome da tabela "alunos"
        ...
        public static function insert($dados)
        {
            $tabela = "estoque"; //uma variável para nome da tabela "alunos"
            $connPdo = new PDO(dbDrive.':host='.dbHost.'; dbname='.dbName, dbUser, dbPass);
            $sql = "insert into $tabela (quantidade) values (:quantidade)";
            $stmt = $connPdo->prepare($sql);
        ...
        {
            $tabela = "estoque"; //uma variável para nome da tabela "alunos"
            $coluna = "idEstoque"; //uma variável para nome "codigo"
            $connPdo = new PDO(dbDrive.':host='.dbHost.'; dbname='.dbName, dbUser, dbPass);
            $sql = "update $tabela set quantidade=:quantidade where $coluna=:idEstoque";
            $stmt = $connPdo->prepare($sql);
            //Mapear os parâmetros para obter os dados de inclusão
