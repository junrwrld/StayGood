<?php
    ...
    include 'Estoque.php'; //incluir o arquivo Estoque.php
    class EstoqueService 
    {
          ...
          {
              if ($id){// se existe $id  
                 //retornar resultado do método select($id) da class Estoque         
                 return Estoque::select($id) ;
              }else{
                 //retornar resultado do método selectAll() da class Estoque
                 return Estoque::selectAll() ;
              }
          ...
          public function put($id = null)
          {
            if ($id == null){
              ...
              return Estoque::update($id,$dados); 
          }
    }